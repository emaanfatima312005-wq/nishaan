...
export default function HowItWorks() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#fbfcf7] text-[#1A1A1A]">
      ...
      <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden bg-[#fbfcf7]">
        <video
          autoPlay
          loop
          muted
          ...
          "
        >
          <source src="/videos/Video%20Project.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </video>

        {/* Main light overlay */}
        <div className="absolute inset-0 bg-[#fbfcf7]/55" />

        {/* Top-to-bottom gradient */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#fbfcf7]/50 via-transparent to-[#fbfcf7]/70" />
      </div>
      ...
      <section className="relative z-10 min-h-[70vh] md:min-h-[75vh] flex items-center justify-center overflow-hidden bg-[#0D3B0D]/55 text-white">
        {/* Hero Overlay */}

        <div className="absolute inset-0 bg-[#0D3B0D]/35" />
        ...
        >
          ...
          >
            How Nishaan
            <br />
            <span className="text-[#5FAF5F]">Finds a Place</span>
          </h1>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="relative shrink-0">
              <div className="w-28 h-28 md:w-36 md:h-36 rounded-full bg-[#0D3B0D] text-white flex items-center justify-center shadow-xl">
                <div className="text-center">
                  <span className="block text-sm text-[#5FAF5F]">STEP</span>
            ...
            <div className="flex-1">
              ...
              <p className="mt-4 max-w-xl text-lg leading-8 text-[#1A1A1A]/70">
                You don't need an exact address or place name. Give Nishaan
                whatever information you remember.
              </p>

              <div className="flex flex-wrap gap-3 mt-7">
                <div className="flex items-center gap-2 px-4 py-3 rounded-xl bg-white/90 backdrop-blur-sm border border-[#C8E6C9] shadow-sm">
          ...
          >
            <div className="shrink-0">
              <div className="w-28 h-28 md:w-36 md:h-36 rounded-full bg-[#2F6B2F] text-white flex items-center justify-center shadow-xl">
                <div className="text-center">
                  <span className="block text-sm text-[#C8E6C9]">STEP</span>
            ...
            <div className="flex-1 md:text-right">
              ...
              <p className="mt-4 max-w-xl md:ml-auto text-lg leading-8 text-[#1A1A1A]/70">
                Nishaan analyzes the information you provide and identifies
                meaningful details that could help describe the location.
              </p>

              <div className="mt-7 flex md:justify-end">
                <div className="inline-flex items-center gap-3 px-5 py-4 rounded-2xl bg-[#C8E6C9]/70 backdrop-blur-sm border border-[#C8E6C9] shadow-sm">
          ...
          >
            <div className="shrink-0">
              <div className="w-28 h-28 md:w-36 md:h-36 rounded-full bg-[#5FAF5F] text-white flex items-center justify-center shadow-xl">
                <div className="text-center">
                  <span className="block text-sm text-white/80">STEP</span>
            ...
            <div className="flex-1">
              ...
              <p className="mt-4 max-w-xl text-lg leading-8 text-[#1A1A1A]/70">
                Important geographic information is separated from the rest of
                the description to help narrow down the possibilities.
              </p>
              ...
              <div className="flex flex-wrap gap-3 mt-7">
                {[
                  ...
                  <span
                    key={item}
                    className="px-4 py-2 rounded-full bg-white/90 backdrop-blur-sm border border-[#C8E6C9] text-sm text-[#2F6B2F] shadow-sm"
                    data-aos="zoom-in"
          ...
          >
            ...
            <div className="flex-1 md:text-right">
              ...
              <p className="mt-4 max-w-xl md:ml-auto text-lg leading-8 text-[#1A1A1A]/70">
                The extracted clues are used alongside geographic information to
                identify places that could match what you described.
              </p>

              <div className="mt-7 flex md:justify-end">
                <div className="relative w-full max-w-sm h-28 rounded-2xl bg-[#0D3B0D] overflow-hidden shadow-xl">
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="mt-4 max-w-xl text-lg leading-8 text-[#1A1A1A]/70">
                Nishaan presents potential locations that you can explore
                visually and compare.
              </p>

              <div className="mt-8 bg-white/90 backdrop-blur-sm rounded-2xl border border-[#C8E6C9] shadow-lg p-5 max-w-md">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <p className="text-sm text-[#1A1A1A]/50">Potential Match</p>
      ...
      <section className="relative z-10 px-6 py-28 bg-[#fbfcf7]/60 backdrop-blur-[2px] overflow-hidden">
        <div
        ...
        >
          ...
          <h2 className="mt-5 text-4xl md:text-6xl font-bold text-[#0D3B0D]">
            ...
            <br />
            <span className="text-[#2F6B2F]">to somewhere you can find.</span>
          </h2>

          {/* Description */}

          <p className="max-w-2xl mx-auto mt-7 text-[#1A1A1A]/70 text-lg leading-8">
            Nishaan brings together AI interpretation and geographic
            intelligence to help turn uncertain clues into potential places.
          </p>
        </div>
      </section>
    </main>
