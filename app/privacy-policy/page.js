    ...
    <main className="relative min-h-screen overflow-hidden bg-[#fbfcf7] text-[#1A1A1A]">
      ...
      <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
        <img
          ...
          alt=""
          className="absolute left-1/2 top-1/2 h-full w-full min-h-full min-w-full -translate-x-1/2 -translate-y-1/2 object-cover opacity-[0.18]"
        />
            ...
            >
              <div>
                ...
                <p className="mt-6 max-w-2xl text-lg leading-8 text-[#C8E6C9]">
                  A simple explanation of how Nishaan handles the information
                  you provide while discovering and identifying locations.
                </p>
        ...
        <section className="max-w-6xl mx-auto px-6 -mt-10 relative z-10">
          <div className="grid md:grid-cols-3 gap-4" data-aos="fade-up">
            ...
            <div className="bg-white rounded-2xl border border-[#C8E6C9] p-6 shadow-lg">
              ...
              <p className="mt-2 text-sm leading-6 text-[#1A1A1A]/60">
                Information is processed to provide and improve Nishaan
                services.
              </p>
            </div>
            ...
            <div className="max-w-3xl">
              ...
              <section id="overview" className="scroll-mt-10 mb-20">
                ...
                <p className="mt-4 leading-8 text-[#1A1A1A]/65">
                  ...
                  when you use Nishaan, why it may be processed, and how we aim
                  to protect it.
                </p>
              </section>
              ...
              <section id="ai" className="scroll-mt-10 mb-20">
                ...
                <div className="mt-7 p-7 rounded-3xl bg-[#0D3B0D] text-white">
                  ...
                  <p className="mt-5 leading-8 text-[#C8E6C9]">
                    ...
                    descriptions, and geographic information in order to
                    generate potential location results.
                  </p>
              ...
              <section id="sharing" className="scroll-mt-10 mb-20">
                ...
                <p className="mt-6 leading-8 text-[#1A1A1A]/65">
                  ...
                  Information may be processed or shared when necessary to
                  operate requested features, support technical functionality,
              ...
              <section id="security" className="scroll-mt-10 mb-20">
                ...
                <div className="mt-7 flex gap-5 p-6 rounded-2xl bg-white border border-[#C8E6C9]">
                  ...
                  <p className="text-sm leading-7 text-[#1A1A1A]/65">
                    ...
                    alteration, or disclosure. However, no internet-based
