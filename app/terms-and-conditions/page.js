      ...
      <section className="bg-[#0D3B0D] text-white px-6 py-20">
        ...
        >
          ...
          <p className="mt-5 max-w-2xl text-[#C8E6C9] leading-7">
            ...
            Nishaan and its location discovery services.
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-3xl border border-[#C8E6C9] p-8 md:p-10 shadow-sm">
            ...
            <p className="leading-8 text-[#1A1A1A]/70">
              Nishaan is an AI-powered geospatial assistance
              system designed to help users explore and identify
              potential locations using images, voice descriptions,
              text, and geographic information.
            </p>

            <p className="mt-4 leading-8 text-[#1A1A1A]/70">
              By accessing or using Nishaan, you agree to comply
          ...
          >
            ...
            <p className="leading-8 text-[#1A1A1A]/70">
              By using Nishaan, you acknowledge that you have
          ...
          >
            ...
            <p className="leading-8 text-[#1A1A1A]/70">
              Users are expected to use Nishaan responsibly and
              only for lawful purposes. You should not attempt to
              misuse, disrupt, damage, or interfere with the
              operation of the website or its services.
            </p>
            ...
            <ul className="mt-5 space-y-3 text-[#1A1A1A]/70">
              ...
              <li className="flex gap-3">
                <span className="text-[#5FAF5F]">•</span>
                Do not attempt to interfere with the website's functionality.
              </li>
          ...
          >
            ...
            <p className="leading-8 text-[#1A1A1A]/70">
              Nishaan uses artificial intelligence to interpret
              user-provided clues and generate potential geographic
              matches.
            </p>
            ...
            <div className="mt-6 rounded-2xl bg-[#C8E6C9]/30 border border-[#C8E6C9] p-5">
              ...
              <p className="mt-2 text-sm leading-7 text-[#1A1A1A]/70">
                AI-generated results are suggestions and should
                not automatically be considered accurate or
                authoritative geographic information. Users should
                independently verify important location information.
              </p>
          ...
          >
            ...
            <p className="leading-8 text-[#1A1A1A]/70">
              Users may provide images, voice recordings, text,
              or other information when interacting with Nishaan.
              Users are responsible for ensuring that the content
              they provide does not violate applicable laws or
          ...
          >
            ...
            <p className="leading-8 text-[#1A1A1A]/70">
              Your use of Nishaan may involve the processing of
              information submitted through the service. Please
              review our Privacy Policy for information about how
          ...
          >
            ...
            <p className="leading-8 text-[#1A1A1A]/70">
              Nishaan is provided as a location assistance and
              exploration tool. We do not guarantee that every
              location identified by the system will be correct,
          ...
          >
            ...
            <p className="mt-4 text-[#C8E6C9] leading-7">
              If you have any questions about Nishaan or these
              Terms & Conditions, please contact the Nishaan team.
            </p>
