...
// Real voice API results are read from sessionStorage.
...
export default function VoiceOutputPage() {
  ...
  useEffect(() => {
    try {
      ...
      if (!stored) {
        setApiError("No voice analysis result was found.");
        return;
      }
      ...
      console.error("Could not read voice result:", error);
  ...
  if (apiError) {
    return (
      <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#fbfcf7] px-5">
        ...
        <div className="relative z-10 max-w-md text-center">
          ...
          <p className="mt-6 text-xl font-semibold text-[#0D3B0D]">
            Voice analysis failed.
          </p>

          <p className="mt-3 text-sm leading-7 text-[#1A1A1A]/60">{apiError}</p>

          <button
            onClick={handleRecordAgain}
            className="mt-6 flex items-center gap-2 rounded-full bg-[#0D3B0D] px-6 py-3.5 text-sm font-bold text-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:bg-[#2F6B2F]"
          >
            <FiRefreshCw size={17} />
            Record Again
          </button>
  ...
  return (
    <main className="relative min-h-screen overflow-hidden text-[#1A1A1A]">
      {/* ================================================= */}
      {/* BACKGROUND VIDEO */}
      {/* ================================================= */}
      ...
      <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden bg-[#fbfcf7]">
        <video
          ...
          playsInline
          preload="auto"
          className="absolute left-1/2 top-1/2 h-full w-full min-h-full min-w-full -translate-x-1/2 -translate-y-1/2 scale-[1.25] object-cover animate-video-fade"
        >
          <source src="/videos/Historic_mosque.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </video>

        <div className="absolute inset-0 bg-[#fbfcf7]/45" />

        <div className="absolute inset-0 bg-gradient-to-b from-[#fbfcf7]/50 via-transparent to-[#fbfcf7]/60" />
      </div>
      ...
      <div className="pointer-events-none fixed left-[-150px] top-[15%] z-[1] h-[500px] w-[500px] rounded-full bg-[#5FAF5F]/10 blur-[120px]" />

      <div className="pointer-events-none fixed bottom-[10%] right-[-150px] z-[1] h-[500px] w-[500px] rounded-full bg-[#2F6B2F]/10 blur-[120px]" />
      ...
      <div className="relative z-10">
        ...
        <section className="mx-auto max-w-7xl px-6 pt-10 md:px-10">
          <div className="flex items-start">
            ...
            <div className="flex flex-1 flex-col items-center">
              ...
              <p className="mt-3 text-sm font-medium text-[#2F6B2F]">Input</p>
            </div>
        ...
        <section className="mx-auto max-w-7xl px-6 pb-20 md:px-10">
          <div className="grid overflow-hidden rounded-[2rem] border border-[#C8E6C9] bg-white/90 shadow-[0_20px_70px_rgba(13,59,13,0.10)] backdrop-blur-sm lg:grid-cols-[1.25fr_0.75fr]">
            {/* ================================================= */}
            {/* REAL MAP */}
            {/* ================================================= */}
            ...
            <div
              className="relative flex flex-col justify-center overflow-hidden bg-white/90 p-8 backdrop-blur-md md:p-12 lg:p-14"
              data-aos="fade-left"
            >
              {/* Decorative glow */}
              ...
              <div className="relative z-10">
                ...
                <div className="mt-10 rounded-2xl border border-[#C8E6C9] bg-[#fbfcf7]/95 p-5">
                ...
                <div className="mt-5 grid grid-cols-2 gap-3">
                  <div className="rounded-xl border border-[#C8E6C9] bg-white/95 p-4">
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  ...
                  <Link
                    href="/voice"
                    className="flex items-center gap-3 rounded-full border border-[#C8E6C9] bg-white/95 px-6 py-3.5 text-sm font-semibold text-[#0D3B0D] transition-all duration-300 hover:-translate-y-1 hover:border-[#5FAF5F]"
                  >
                    <FiSearch />
                    Try Again
                  </Link>
