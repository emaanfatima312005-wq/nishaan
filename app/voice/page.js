...
export default function VoicePage() {
  ...
  const handleFile = (file) => {
    ...
    if (!file.type.startsWith("audio/")) {
      setRecordingError("Please select a valid audio file.");
      return;
    }
  ...
  const startRecording = async () => {
    ...
    try {
      ...
      console.error("[Nishaan] Microphone access error:", error);

      setRecordingError(
        "Microphone access is required for voice recording. Please allow microphone access in your browser.",
      );
  ...
  const handleAnalyzeVoice = async () => {
    ...
    if (!file) {
      setRecordingError("Please record or upload an audio file first.");
      return;
    }
    ...
    <main className="relative min-h-screen overflow-hidden text-[#1A1A1A]">
      ...
      <div className="relative z-10">
        ...
        <section className="mx-auto max-w-7xl px-6 pt-12 md:px-10">
          <div className="flex items-start">
            ...
            <div className="flex flex-1 flex-col items-center">
              ...
              <p className="mt-3 text-sm font-medium text-[#0D3B0D]">Input</p>
            </div>
            ...
            <div className="flex flex-1 flex-col items-center">
              ...
              <p className="mt-3 text-sm text-[#1A1A1A]/60">Analyzing</p>
            </div>
            ...
            <div className="flex flex-1 flex-col items-center">
              ...
              <p className="mt-3 text-sm text-[#1A1A1A]/60">Output</p>
            </div>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-5xl px-6 pb-20 pt-20 text-center">
          ...
          <div
            className={`relative mx-auto mt-12 max-w-4xl overflow-hidden rounded-[2rem] border bg-white/90 p-7 shadow-xl backdrop-blur-md transition-[border-color,box-shadow] duration-500 md:p-10 ${
              isRecording
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="relative mx-auto flex h-24 w-24 items-center justify-center">
                {isRecording && (
                  <>
                    ...
                    <span className="absolute -inset-4 animate-pulse rounded-full border border-[#5FAF5F]/20" />

                    <span className="absolute -inset-8 animate-pulse rounded-full border border-[#5FAF5F]/10" />
                  </>
                )}
              ...
              {audioFile && (
                <div className="mt-6 rounded-2xl border border-[#C8E6C9] bg-[#fbfcf7]/95 p-5 text-left">
