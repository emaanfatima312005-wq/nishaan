        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 className="text-2xl font-bold tracking-wide">NISHAAN</h2>
            ...
            <p className="text-[#C8E6C9] text-sm leading-6 max-w-sm">
              Bridging technology and exploration — helping you find any place,
              from any clue.
            </p>
            ...
            <div className="flex gap-3 mt-5">
              {/* Facebook */}
              <a
                href="https://www.facebook.com/share/1KTbp3gwqg/"
                aria-label="Facebook"
              ...
              {/* LinkedIn */}
              <a
                href="https://www.linkedin.com/company/nishaan-pakistan/"
                aria-label="LinkedIn"
                className="w-9 h-9 rounded-full border border-[#5FAF5F]
                flex items-center justify-center
                text-[#C8E6C9] font-bold text-sm
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/nishaan_pakistan.pk?igsi=MWFibHZkOHppNjBlOA=="
                target="_blank"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 py-4">
          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <span>© 2026 Nishaan. All rights reserved.</span>
            ...
            <div className="flex items-center gap-2">
              ...
              <span>Built for a smarter, connected world.</span>
            </div>
          </div>
        </div>
      </div>
